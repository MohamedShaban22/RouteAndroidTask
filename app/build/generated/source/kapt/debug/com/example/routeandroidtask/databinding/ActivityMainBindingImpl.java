...
public class ActivityMainBindingImpl extends ActivityMainBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.search_view, 2);
        sViewsWithIds.put(R.id.shoping, 3);
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.vm == variableId) {
            setVm((com.example.routeandroidtask.ProductsViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setVm(@Nullable com.example.routeandroidtask.ProductsViewModel Vm) {
        this.mVm = Vm;
    }
